...
#            }
      ...
      module InstanceMethods
        ...
        def full_set(special=nil, includes=nil)
          ...
          base_set_class.find(:all, :conditions => "#{scope_condition} #{exclude_str} AND (#{left_col_name} BETWEEN #{self[left_col_name]} AND #{self[right_col_name]})", 
            :order => left_col_name, :include => includes)
        end
